...
if __name__ == '__main__':
	...
	for state in list_state:
		...
		for f in state_df.columns:
			...
			temp_pred_actual[f+'_actual'] = test_y
			temp_pred_actual[f+'_pred'] = [pred[0] for pred in pred_y]
			...
			pyplot.plot(test_y, color='blue', label="prediction" )
			pyplot.plot([pred[0] for pred in pred_y], color='red', label="prediction")
			...
			temp_future_pred[f+'_pred'] = future_pred
